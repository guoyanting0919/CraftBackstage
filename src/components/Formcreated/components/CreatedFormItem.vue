  ...
  <el-form-item :label="formData.name" :prop="formData.model">
    <template v-if="formData.type == 'input'">
      <el-input v-if="
        ...
        " :type="formData.options.dataType" v-model.number="dataModel" :placeholder="formData.options.placeholder" :style="{ width: formData.options.width }" :disabled="formData.options.disabled"></el-input>
    ...
    <template v-if="formData.type == 'radio'">
      <el-radio-group v-model="dataModel" :style="{ width: formData.options.width }" :disabled="formData.options.disabled">
        <el-radio :style="{
          ...
          }" :label="item.value" v-for="(item, index) in formData.options.remote
            ? formData.options.remoteOptions
            : formData.options.options" :key="index">
    ...
    <template v-if="formData.type == 'select'">
      <el-select v-model="dataModel" :disabled="formData.options.disabled" :multiple="formData.options.multiple" :clearable="formData.options.clearable" :placeholder="formData.options.placeholder" :style="{ width: formData.options.width }" :filterable="formData.options.filterable">
        <el-option v-for="item in formData.options.remote
            ? formData.options.remoteOptions
            : formData.options.options" :key="item.value" :value="item.value" :label="
    ...
    <template v-if="formData.type === 'imgupload'">
      <Upload v-model="dataModel" :disabled="formData.options.disabled" :style="{ width: formData.options.width }" :width="formData.options.size.width" :height="formData.options.size.height" :token="formData.options.token" :domain="formData.options.domain" :multiple="formData.options.multiple" :length="formData.options.length" :is-qiniu="formData.options.isQiniu" :is-delete="formData.options.isDelete" :min="formData.options.min" :is-edit="formData.options.isEdit" :action="formData.options.action"></Upload>
    </template>
    ...
    <template v-if="formData.type == 'cascader'">
      <el-cascader v-model="dataModel" :disabled="formData.options.disabled" :clearable="formData.options.clearable" :placeholder="formData.options.placeholder" :style="{ width: formData.options.width }" :options="formData.options.remoteOptions"></el-cascader>
    </template>
