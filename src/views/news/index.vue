  ...
  <div class="flex-column">
    <sticky :className="'sub-navbar'">
      <div class="filter-container">
        <el-select v-model="getNewsType" class="mr-20" placeholder="請選擇類別" no-match-text="暫無數據" @change="filterType">
    ...
    <el-dialog :title="modalTitle" :visible.sync="openModal" width="60%">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="right" label-width="100px">
        ...
        <el-form-item size="small" :label="'類別'" prop="newsTypeId">
          <el-select v-model="temp.newsTypeId" class="fw" placeholder="請選擇類別" no-match-text="暫無數據" @change="getTypeName">
            <el-option v-for="item in typeList" :key="item.id" :label="item.name" :value="item.dtValue">
            </el-option>
          </el-select>
        </el-form-item>
